...
共${pagebean.count }条记录,&nbsp第${pagebean.p }页/共${pagebean.pagetotal }页&nbsp <a
			href="ProviderServlet?cmd=getproviderByInfo&p=1">首页</a>&nbsp <a
			href="ProviderServlet?cmd=getproviderByInfo&p=${pagebean.p-1 }">上一页</a>&nbsp <a
			href="ProviderServlet?cmd=getproviderByInfo&p=${pagebean.p+1 }">下一页</a>&nbsp <a
			href="ProviderServlet?cmd=getproviderByInfo&p=${pagebean.pagetotal }">尾页</a>&nbsp跳到第
...
<script type="text/javascript">
function toPage(){
	location="ProviderServlet?cmd=getproviderByInfo&p="+${pagebean.p};
}
function setP(){
