...
<body>
	<div class="main">
		...
		<form id="form1" name="form1" method="post" action="../ProviderServlet?cmd=addProvider"
			...
			<div class="buttons">
				 <input name="button" id="button" value="提交" 
				 class="input-button" type="submit">
				 <input name="button" id="button"onclick="window.location='provider.do';" 
				 value="返回" class="input-button" type="button">
			</div>
		</form>
	</div>
</body>
