package com.qhit.lh.gr3.sakura.exam.bjgl.bean;
...
public class ClassInfo implements java.io.Serializable {
	...
	/** minimal constructor */
	public ClassInfo(String cname, String major, String insId, String iecId,
			String cdate) {
		this.cname = cname;
		this.major = major;
		this.insId = insId;
	...
	/** full constructor */
	public ClassInfo(String cname, String major, String insId, String iecId,
			String cdate, Integer g1num, Integer g2num, Integer g3num,
