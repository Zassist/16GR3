...
public class AccountDaoImpl implements AccountDao{
     ...
     * 分页
     * (non-Javadoc)
     * @see com.qhit.sbm.account.dao.AccountDao#getPageBean(com.qhit.sbm.common.bean.PageBean)
     */
     ...
     * 添加账单
     * (non-Javadoc)
     * @see com.qhit.sbm.account.dao.AccountDao#addAccount(com.qhit.sbm.goods.bean.Goods, int, int, int)
     */
	 ...
	 * 根据参数查询
	 * (non-Javadoc)
	 * @see com.qhit.sbm.account.dao.AccountDao#getPageBeanByParam(java.util.List, java.util.List)
	 */
	 ...
	 * 
	 * (non-Javadoc)
	 * @see com.qhit.sbm.account.dao.AccountDao#deleteAccountById(int)
	 */
		@Override
