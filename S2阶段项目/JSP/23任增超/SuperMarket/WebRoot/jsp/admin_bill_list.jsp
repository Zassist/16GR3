...
<body>
	<div class="menu">
		<form method="get" action="AccountServlet?cmd=getAccountByParam">
			...
			<table class="list">
				...
				<c:forEach items="${pageBean.data }" var="accountDetail">
					<tr>
						...
						<td><a href="../ProviderServlet?cmd=getAllProvider&&action=update&&accountId=${accountDetail.accountId }">修改</a></td>
					</tr>
				</c:forEach>
			</table>
		</div>
		<form id="form" action="AccountServlet?cmd=getPageBean">
    ...
    <a class="input-button" href="AccountServlet?cmd=getPageBean&p=${pageBean.p - 1 }">上一页</a>
    <a class="input-button" href="AccountServlet?cmd=getPageBean&p=${pageBean.p + 1 }">下一页</a>
	</div>
